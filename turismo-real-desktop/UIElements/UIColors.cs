...
namespace turismo_real_desktop.UIElements
{
    public static class UIColors
    {
        ...
        public static Brush NormalGreen = (Brush)new BrushConverter().ConvertFrom("#60A917");
        public static Brush HoverGreen = (Brush)new BrushConverter().ConvertFrom("#518E13");
        ...
        public static Brush White = (Brush)new BrushConverter().ConvertFrom("#FFFFFF");
